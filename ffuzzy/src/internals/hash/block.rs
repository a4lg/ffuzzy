...
/// [`FuzzyHashData::compare_block_sizes()`](crate::internals::hash::FuzzyHashData::compare_block_sizes()).
///
/// # Compatibility Note
///
...
pub mod block_size {
    ...
    /// [`MIN`] * 2<sup>n</sup> (a power of two where `n` ≧ 0).
    ///
    ...
    ///
    /// See also:
    /// ["Block Size" section of `FuzzyHashData`](crate::internals::hash::FuzzyHashData#block-size)
    ...
    /// from [`FuzzyHash::to_string()`](crate::internals::hash::FuzzyHash::to_string()).
...
///
/// See also: ["Block Hashes" section of `FuzzyHashData`](crate::internals::hash::FuzzyHashData#block-hashes)
pub mod block_hash {
    ...
    ///
    /// See also:
    /// ["Truncation" section of `FuzzyHashData`](crate::internals::hash::FuzzyHashData#truncation)
    ...
    /// [have a common substring](crate::internals::compare::position_array::BlockHashPositionArrayImpl::has_common_substring())
    ...
    /// [two normalized fuzzy hashes are different](crate::internals::hash::FuzzyHashData#fuzzy-hash-comparison)).
    ///
    ...
    ///
    /// See also: ["Fuzzy Hash Comparison" section of `FuzzyHashData`](crate::internals::hash::FuzzyHashData#fuzzy-hash-comparison)
    ...
    ///
    /// *   [`FuzzyHashData::block_hash_1_numeric_windows()`](crate::internals::hash::FuzzyHashData::block_hash_1_numeric_windows())
    /// *   [`FuzzyHashData::block_hash_2_numeric_windows()`](crate::internals::hash::FuzzyHashData::block_hash_2_numeric_windows())
    ///
    /// Unlike [`block_hash_1_windows()`](crate::internals::hash::FuzzyHashData::block_hash_1_windows()) and
    /// [`block_hash_2_windows()`](crate::internals::hash::FuzzyHashData::block_hash_2_windows()),
    ...
    ///
    /// See also: [`FuzzyHashData::block_hash_1_windows()`](crate::internals::hash::FuzzyHashData::block_hash_1_windows())
    ///
    /// *Note*:
    ...
    /// (*normalized forms only*):
    ///
    /// *   [`FuzzyHashData::block_hash_1_index_windows()`](crate::internals::hash::FuzzyHashData::block_hash_1_index_windows())
    /// *   [`FuzzyHashData::block_hash_2_index_windows()`](crate::internals::hash::FuzzyHashData::block_hash_2_index_windows())
    ///
