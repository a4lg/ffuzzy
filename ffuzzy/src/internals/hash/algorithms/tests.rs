...
//! Tests: [`crate::internals::hash::algorithms`].

#![cfg(test)]

use alloc::format;

use crate::internals::base64::{base64_index, BASE64_TABLE_U8};
use crate::internals::hash::algorithms::{
    BlockHashParseState,
...
use crate::internals::test_utils::eq_slice_buf;
