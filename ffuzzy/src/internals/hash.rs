...
use crate::internals::base64::BASE64_TABLE_U8;
...
/// block hash 1.
///
/// Since ssdeep uses [a 32-bit hash function](crate::internals::generate::RollingHash)
...
/// prevent exaggeration of matches](crate::internals::compare::FuzzyHashCompareTarget::score_cap_on_block_hash_comparison())).
///
...
///
/// ssdeep normally generates (as well as [`Generator`](crate::internals::generate::Generator))
...
///     For instance, [`FuzzyHashCompareTarget::is_comparison_candidate()`](crate::internals::compare::FuzzyHashCompareTarget::is_comparison_candidate())
...
///         ["candidate of edit distance-based comparison"](crate::internals::compare::FuzzyHashCompareTarget::is_comparison_candidate())
///         relations.
///
///     2.  Compute the edit distance between two block hashes and
///         [scale it](crate::internals::compare::FuzzyHashCompareTarget::raw_score_by_edit_distance())
...
///
///     3.  For [small effective block sizes](crate::internals::compare::FuzzyHashCompareTarget::LOG_BLOCK_SIZE_CAPPING_BORDER),
///         [cap the score to prevent exaggerating the matches](crate::internals::compare::FuzzyHashCompareTarget::score_cap_on_block_hash_comparison()).
///
...
/// [`FuzzyHashCompareTarget`](crate::internals::compare::FuzzyHashCompareTarget)
/// object or corresponding
/// [half-baked object](crate::internals::compare::position_array::BlockHashPositionArray)
/// is used.
///
/// See [`FuzzyHashCompareTarget`](crate::internals::compare::FuzzyHashCompareTarget) for details.
#[repr(align(8))]
#[derive(Copy, Clone)]
...
crate::internals::macros::impl_error!(FuzzyHashOperationError {});
...
/// *   [`FuzzyHashDualData::from_bytes_with_last_index_internal()`](crate::internals::hash_dual::FuzzyHashDualData::from_bytes_with_last_index_internal())
    ...
    BlockHashSizes<S1, S2>: ConstrainedBlockHashSizes,
{
    ...
    /// equivalent to [`FuzzyHashCompareTarget::is_comparison_candidate()`](crate::internals::compare::FuzzyHashCompareTarget::is_comparison_candidate())
...
/// *   Retrieve a fuzzy hash generated by [`Generator`](crate::internals::generate::Generator)
...
/// Test utilities for [`crate::internals::hash`].
#[cfg(any(test, doc))]
