...
//! Tests: [`crate::internals::hash_dual`].
...
use crate::internals::hash::FuzzyHashData;
use crate::internals::hash::block::block_size;
use crate::internals::hash::parser_state::{ParseError, ParseErrorKind, ParseErrorOrigin};
use crate::internals::hash::tests::{FuzzyHashStringBytes, PARSER_ERR_CASES};
use crate::internals::hash::test_utils::test_blockhash_contents_all;
use crate::internals::hash_dual::{DualFuzzyHash, LongDualFuzzyHash, rle_encoding};
