...
use crate::internals::hash::{fuzzy_norm_type, fuzzy_raw_type, FuzzyHashData};
use crate::internals::intrinsics::unlikely;
...
mod algorithms {
        ...
        ReconstructionBlockSize<SZ_BH, SZ_RLE>: ConstrainedReconstructionBlockSize,
    {
        ...
        let mut seq = 0usize;
        let mut len = 0usize;
        let mut prev = crate::internals::base64::BASE64_INVALID;
...
/// (e.g. [`FuzzyHashCompareTarget::compare()`](crate::internals::compare::FuzzyHashCompareTarget::compare())).
///
/// # Ordering
///
    ...
    ReconstructionBlockSize<S2, C2>: ConstrainedReconstructionBlockSize,
{
    ...
    /// [block hash 1](crate::internals::hash::FuzzyHashData::blockhash1).
    ///
    /// See [`rle_encoding`] for encoding details and full compression scheme.
    rle_block1: [u8; C1],

    /// RLE block 2 for reverse normalization of
    /// [block hash 2](crate::internals::hash::FuzzyHashData::blockhash2).
    ///
    /// See [`rle_encoding`] for encoding details and full compression scheme.
    rle_block2: [u8; C2],
    ...
    ReconstructionBlockSize<S2, C2>: ConstrainedReconstructionBlockSize,
{
    ...
    ///
    /// See also: ["Block Size" section of `FuzzyHashData`](crate::internals::hash::FuzzyHashData#block-size)
    #[inline(always)]
    ...
    fn from_bytes_with_last_index_internal(
        ...
        use crate::internals::hash::{
            algorithms, hash_from_bytes_with_last_index_internal_template,
        };
        use crate::internals::hash_dual::algorithms::update_rle_block;
...
///
/// *   [`FuzzyHash`](crate::internals::hash::FuzzyHash) (native)
/// *   [`RawFuzzyHash`](crate::internals::hash::RawFuzzyHash) (compressed)
///
...
/// This type effectively contains the data equivalent to those two objects:
///
/// *   [`LongFuzzyHash`](crate::internals::hash::LongFuzzyHash) (native)
/// *   [`LongRawFuzzyHash`](crate::internals::hash::LongRawFuzzyHash) (compressed)
///
/// See also: [`FuzzyHashDualData`]
